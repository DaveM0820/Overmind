...
public class InfantyUnitBehaviour : MonoBehaviour, IUnitActionInterface
{
    ...
    public void UpdateUnit() {
        ...
        {
            case 1:
            Move(currentMoveTarget, finalDestination);
    ...
    public void Attack(GameObject target) {
        ...
        distanceCheckCount+= jobManager.updateTimestep;
    ...
    public void EnterDirectControl() {
        ...
        Stop();
        UnityEngine.Debug.Log("EnterDirectControl Done headpos " + rigTargetHead.position);
    }
    ...
    public void UnderDirectControl() {
        ...
        UnityEngine.Debug.Log("vrTargetRightHand.position " + vrTargetRightHand.position);
        UnityEngine.Debug.Log("rigTargetRightHand.position " + rigTargetRightHand.position);
        UnityEngine.Debug.Log("unitMeshAndRig.GetComponent<RigBuilder>().enabled " + unitMeshAndRig.GetComponent<RigBuilder>().enabled);
    ...
    public void Move(Vector3 movetarget, bool finalDestination) {
